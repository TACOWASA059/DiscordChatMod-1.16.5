package com.github.tacowasa059.discordchatmod;
...
public class DiscordChatMod {
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("discordchatmod", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
    ...
    public void onServerStarting(FMLServerStartingEvent event) {
        ...
        LOGGER.info("["+DiscordChatMod.MOD_ID+"]HELLO from server starting");
    }
    ...
    public void commonSetUp(final FMLCommonSetupEvent event){
        ClientToServerNetwork.init();
        ServerToClientNetwork.init();
    }
}
